...
// --- ACHIEVEMENTS MASTER LIST (Cleaned up) ---
export const MASTER_ACHIEVEMENTS: Achievement[] = [
    ...
    { id: 'ach_14', code: 'NIGHT_OWL', name: 'Ночной дожор', description: 'Удобрить растение после 22:00', icon: '🦉', rarity: AchievementRarity.COMMON },
    { id: 'ach_15', code: 'SURVIVOR', name: 'Выживший', description: 'Растение живет у вас уже месяц', icon: '🗓️', rarity: AchievementRarity.COMMON },

    // --- Tech / AI ---
    { id: 'ach_16', code: 'PHOTOGRAPHER', name: 'Фотограф', description: 'Обновить фото растения', icon: '📸', rarity: AchievementRarity.COMMON },
    { id: 'ach_17', code: 'AI_SCIENTIST', name: 'Ученый', description: 'Определить вид растения через AI', icon: '🤖', rarity: AchievementRarity.RARE },
    { id: 'ach_18', code: 'PLANT_DOCTOR', name: 'Доктор Хаус', description: 'Провести диагностику болезни через AI', icon: '🩺', rarity: AchievementRarity.RARE },
    { id: 'ach_19', code: 'CHATTERBOX', name: 'Собеседник', description: 'Поговорить со своим растением в чате', icon: '💬', rarity: AchievementRarity.COMMON },

    // --- Social / Market ---
    { id: 'ach_20', code: 'FIRST_FRIEND', name: 'Ты мне друг?', description: 'Добавить первого друга', icon: '🤝', rarity: AchievementRarity.COMMON },
    { id: 'ach_21', code: 'POPULAR', name: 'Душа компании', description: 'Иметь 5 друзей садоводов', icon: '😎', rarity: AchievementRarity.RARE },
    { id: 'ach_22', code: 'FIRST_LISTING', name: 'Предприниматель', description: 'Разместить первое объявление на рынке', icon: '🏷️', rarity: AchievementRarity.COMMON },
    { id: 'ach_23', code: 'MARKET_GURU', name: 'Гуру рынка', description: 'Разместить 5 объявлений', icon: '📈', rarity: AchievementRarity.EPIC },
    { id: 'ach_24', code: 'HELPFUL_NEIGHBOR', name: 'Добрый сосед', description: 'Посмотреть профиль друга', icon: '👋', rarity: AchievementRarity.COMMON },

    // --- Specific Types ---
    { id: 'ach_25', code: 'SUCCULENT_LOVER', name: 'Колючий характер', description: 'Иметь 3 суккулента или кактуса', icon: '🌵', rarity: AchievementRarity.RARE },
    { id: 'ach_26', code: 'TROPICAL_VIBES', name: 'Тропики', description: 'Иметь 3 пальмы или лиственных растения', icon: '🏖️', rarity: AchievementRarity.RARE },
    { id: 'ach_27', code: 'FLOWER_POWER', name: 'Сила цветов', description: 'Иметь 3 цветущих растения', icon: '💐', rarity: AchievementRarity.RARE },
    
    // --- Levels ---
    { id: 'ach_28', code: 'LEVEL_10', name: 'Грандмастер', description: 'Достичь 10 уровня профиля', icon: '🎓', rarity: AchievementRarity.LEGENDARY },
];
